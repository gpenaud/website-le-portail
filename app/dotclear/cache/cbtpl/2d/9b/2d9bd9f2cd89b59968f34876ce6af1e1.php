...
<body class="dc-category">
	...
	<div id="content-info">
      <h2 class="post-title cat-<?php $_ctx->pcategories = $core->blog->getCategoryParent($_ctx->categories->cat_id);
if($_ctx->pcategories->count()==0){$_ctx->pcategories=$core->blog->getCategory($_ctx->categories->cat_id);}
echo context::global_filters($_ctx->pcategories->cat_id,array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'strip_tags' => 0,
  'id' => '1',
),'CategoryParent');unset($_ctx->pcategories);
?> li-<?php $_ctx->pcategories = $core->blog->getCategoryParent($_ctx->categories->cat_id);
if($_ctx->pcategories->count()==0){$_ctx->pcategories=$core->blog->getCategory($_ctx->categories->cat_id);}
echo context::global_filters($_ctx->pcategories->cat_id,array (
  0 => NULL,
  'encode_xml' => 0,
...
?>">
  ...
  'strip_tags' => 0,
        ...
        <!-- 0 for category <?php echo context::global_filters($core->blog->url.$core->url->getURLFor("category",$_ctx->categories->cat_url),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
...
<?php while ($_ctx->posts->fetch()) : ?>
		<?php if ($_ctx->posts->isStart()) : ?>
			<div id="cat-news">
				<h2 class="post-title">Dernières nouvelles</h2>
				<ul>
		<?php endif; ?>
...
echo context::global_filters($_ctx->entrycategories->cat_id,array (
  ...
  echo "";
endif?>"><a href="<?php echo context::global_filters($_ctx->posts->getURL(),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'capitalize' => 0,
  'strip_tags' => 0,
),'EntryTitle'); ?></a> <i>(<?php echo context::global_filters($_ctx->posts->getDate('',''),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'strip_tags' => 0,
	...
	<?php endwhile; $_ctx->posts = null; $_ctx->post_params = null; ?>
        ...
        <!-- 1 for category <?php echo context::global_filters($core->blog->url.$core->url->getURLFor("category",$_ctx->categories->cat_url),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
...
<?php while ($_ctx->posts->fetch()) : ?>
  ...
  'strip_tags' => 0,
			...
			<h2 class="post-title cat-<?php if($_ctx->posts->cat_id != null) :
$_ctx->entrycategories = $core->blog->getCategoryParents($_ctx->posts->cat_id);
//while(!$_ctx->entrycategories->isEnd()){$_ctx->entrycategories->fetch();}
if($_ctx->entrycategories->count()==0){$_ctx->entrycategories=$core->blog->getCategory($_ctx->posts->cat_id);}
echo context::global_filters($_ctx->entrycategories->cat_id,array (
...
$_ctx->meta = $core->meta->getMetaRecordset($_ctx->posts->post_meta,'tag'); $_ctx->meta->sort('meta_id_lower','asc'); ?><?php while ($_ctx->meta->fetch()) : ?>
  ...
  'strip_tags' => 0,
			...
			<?php if($_ctx->posts->isExtended()) : ?>
				<div class="post-content"><?php echo context::global_filters($_ctx->posts->getExcerpt(0),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
...
<?php if ($_ctx->pagination->f(0) > $_ctx->posts->count()) : ?>
  ...
  'offset' => '-1',
		...
		<?php endif; ?>
	<?php endwhile; $_ctx->posts = null; $_ctx->post_params = null; ?>
        <!-- 2 for category <?php echo context::global_filters($core->blog->url.$core->url->getURLFor("category",$_ctx->categories->cat_url),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
...
while ($_ctx->categories->fetch()) : ?>
        <!-- 3-<?php echo context::global_filters((!$_ctx->cur_loop ? 0 : $_ctx->cur_loop->index() + 1),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'capitalize' => 0,
  'strip_tags' => 0,
),'LoopIndex'); ?> for category <?php echo context::global_filters($core->blog->url.$core->url->getURLFor("category",$_ctx->categories->cat_url),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'strip_tags' => 0,
		...
		<?php endif; ?>
   		<div id="p<?php echo context::global_filters($_ctx->categories->cat_title,array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
...
?>"><a href="<?php echo context::global_filters($core->blog->url.$core->url->getURLFor("category",$_ctx->categories->cat_url),array (
  ...
  'strip_tags' => 0,
        	...
        	<div class="post-content"><?php echo context::global_filters($_ctx->categories->cat_desc,array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
...
?>
<?php while ($_ctx->posts->fetch()) : ?>
            	<?php if ($_ctx->posts->isStart()) : ?><ul> <?php endif; ?>
  ...
  'strip_tags' => 0,
            	...
            	<?php if ($_ctx->posts->isEnd()) : ?></ul><?php endif; ?>
        	<?php endwhile; $_ctx->posts = null; $_ctx->post_params = null; ?>
   		</div>
