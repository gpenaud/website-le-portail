...
<head>
	...
	<title><?php echo __('Tag'); ?> - <?php echo context::global_filters($_ctx->meta->meta_id,array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'capitalize' => 0,
  'strip_tags' => 0,
),'TagID'); ?> - <?php echo context::global_filters($core->blog->name,array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => '1',
  'cut_string' => 0,
...
<?php if ($_ctx->pagination->f(0) > $_ctx->posts->count()) : ?>
  ...
  'strip_tags' => 0,
	...
	<link rel="alternate" type="application/atom+xml" title="Atom 1.0" href="<?php echo context::global_filters($core->blog->url.$core->url->getURLFor("tag_feed",rawurlencode($_ctx->meta->meta_id)."/atom"),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
...
<body class="dc-tag">
	...
	<div id="content-info">
		<h2><?php echo __('Tag'); ?> - <?php echo context::global_filters($_ctx->meta->meta_id,array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
...
echo context::global_filters($_ctx->entrycategories->cat_id,array (
  ...
  echo "";
endif?> li-<?php if($_ctx->posts->cat_id != null) :
$_ctx->entrycategories = $core->blog->getCategoryParents($_ctx->posts->cat_id);
//while(!$_ctx->entrycategories->isEnd()){$_ctx->entrycategories->fetch();}
if($_ctx->entrycategories->count()==0){$_ctx->entrycategories=$core->blog->getCategory($_ctx->posts->cat_id);}
echo context::global_filters($_ctx->entrycategories->cat_id,array (
  ...
  'strip_tags' => 0,
			...
			- <a href="<?php echo context::global_filters($_ctx->posts->getCategoryURL(),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
