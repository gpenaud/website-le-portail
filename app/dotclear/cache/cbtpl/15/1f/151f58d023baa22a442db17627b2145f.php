...
<feed xmlns="http://www.w3.org/2005/Atom"
  ...
  xml:lang="<?php echo context::global_filters($core->blog->settings->system->lang,array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
...
<?php while ($_ctx->posts->fetch()) : ?>
  ...
  'capitalize' => 0,
  'strip_tags' => 0,
),'EntryURL'); ?>" rel="alternate" type="text/html"
    title="<?php echo context::global_filters($_ctx->posts->post_title,array (
  0 => NULL,
  'encode_xml' => '1',
  'encode_html' => 0,
  ...
  'iso8601' => '1',
    ...
    <?php endif; ?>
    <author><name><?php echo context::global_filters($_ctx->posts->getAuthorCN(),array (
  0 => NULL,
  'encode_xml' => '1',
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'capitalize' => 0,
  'strip_tags' => 0,
),'EntryAuthorCommonName'); ?></name></author>
  ...
  'strip_tags' => 0,
    ...
    <?php endif; ?>
    <?php
$_ctx->meta = $core->meta->getMetaRecordset($_ctx->posts->post_meta,'tag'); $_ctx->meta->sort('meta_id_lower','asc'); ?><?php while ($_ctx->meta->fetch()) : ?><dc:subject><?php echo context::global_filters($_ctx->meta->meta_id,array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'capitalize' => 0,
  'strip_tags' => 0,
),'TagID'); ?></dc:subject><?php endwhile; $_ctx->meta = null; ?>
  ...
  'absolute_urls' => '1',
    ...
    <?php echo context::global_filters($_ctx->posts->getContent(1),array (
  0 => NULL,
  'encode_xml' => '1',
  'encode_html' => 0,
  'cut_string' => 0,
