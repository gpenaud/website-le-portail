        ...
        if (type == 'image') {
            if (editor.mode == 'wysiwyg') {
                ...
                if (media_legend != '' && media_legend != 'none') {
                    params.imgAlt = window.opener.CKEDITOR.tools.htmlEncodeAttr(window.opener.$.stripBaseURL($('input[name="title"]', insert_form).val()));
                } else {
                    params.imgAlt = '';
                }
                ...
                var figure = window.opener.CKEDITOR.dom.element.createFromHtml(block.output(params), editor.document);
